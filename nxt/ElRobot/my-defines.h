...
#define _MY_OPEN_DEFINES_
	...
	#define MIN_VALUE_RED 130//0
	#define MAX_VALUE_RED 256

	#define MIN_HUE_RED 50//80
	#define MAX_HUE_RED 256

	#define MIN_SATURATION_RED 150//100
	...
	#define world_width 35//54
	#define world_height 28//200
...
#define _MY_V4L_DEFINES_
	...
	#define WIDTH 640//160
	#define HEIGHT 480//120
